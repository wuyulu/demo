 ...
 * generated in the net.whir.jaxws.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://ws.jaxws.whir.net/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://ws.jaxws.whir.net/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.whir.jaxws.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.whir.net/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.jaxws.whir.net/", name = "queryWeather")
